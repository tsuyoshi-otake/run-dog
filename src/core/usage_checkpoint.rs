...
mod tests {
        ...
        let mut checkpoint = UsageCheckpoint {
            ...
            snapshot: UsageSnapshot {
                claude: ProviderUsage {
                    today_cents: 12,
                    month_cents: 28_449,
                    today_cost_nanos: 12 * crate::core::NANOS_PER_CENT,
                    month_cost_nanos: 28_449 * crate::core::NANOS_PER_CENT,
                ...
                codex: ProviderUsage {
                    today_cents: 56,
                    month_cents: 879_982,
                    today_cost_nanos: 56 * crate::core::NANOS_PER_CENT,
                    month_cost_nanos: 879_982 * crate::core::NANOS_PER_CENT,
    ...
    #[test]
    fn component_v1_v2_v3_and_incomplete_checkpoints_are_rejected() {
